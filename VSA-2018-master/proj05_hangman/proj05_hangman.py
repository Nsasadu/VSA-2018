...
while True:
    ...
    while counter > 0:
        ...
        if word_list == blanks:
            ...
            break
    if counter == 0:
        print "You did not guess the word " + word + ". You should try again."
    repeat = raw_input("Enter s to start over or enter n to exit: ")
    if repeat.lower() == "s":
        continue
    if repeat.lower() == 'n':
        print "To rerun the program, click on the green play button."
        break
